...
export default function CTASectionUI() {
                    ...
                    <div className="grid gap-3 md:grid-cols-3 md:justify-items-start h-screen">
                        <div className="md:col-span-2 md:col-start-1 flex flex-col gap-3" >
                            ...
                            <div className=" flex flex-col gap-2 md:flex-row md:justify-normal">
                                <a href="https://play.google.com/store/apps/details?id=com.hundredx.devs" target="_blank" rel="noopener noreferrer" className="flex w-full justify-center items-center gap-2 h-10 rounded-lg text-sm bg-white md:max-w-40 dark:text-black">
                                    <RiDownload2Fill />
                                    <div>Download App</div>
                                </a>
                                <a href="https://harkirat.classx.co.in/new-courses" target="_blank" rel="noopener noreferrer" className="flex w-full justify-center items-center gap-2 h-10 rounded-lg text-sm bg-[#1F2937] text-white md:max-w-44">
                                    <LuSparkles />
                                    <div>Join Now</div>
                                </a>
                            </div>
                        </div>
                        <div className="md:col-span-1 md:col-start-3 transform transition-transform rotate-3 animate-bounce-slow hover:rotate-12">
